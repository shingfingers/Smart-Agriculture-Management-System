...
import com.itwork.farm_plant.mapper.LandMapper;
import com.itwork.farm_plant.mapper.TaskBatchMapper;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import com.itwork.farm_plant.entity.TaskBatch;
...
public class TaskBatchService {
    ...
    public boolean addTaskBatch(TaskBatch taskBatch){
        ...
        taskBatchMapper.insert(taskBatch);
        // 修改地块的种质批次
        Long landId = taskBatch.getLandId();
